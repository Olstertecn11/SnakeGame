...
function love.draw()
	...
	love.graphics.print("Points", love.graphics.newFont(28), 340, 5)
	love.graphics.print(points, love.graphics.newFont(25), 345, 35)
    ...
    for segmentIndex, segment in ipairs(snakeSegments) do
	    ...
	    love.graphics.print("GAME OVER", love.graphics.newFont(30), 100, 40)
